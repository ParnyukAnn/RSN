...
public class RemindDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog (Bundle savedInstanceState){
        ...
        nameView = (EditText) view.findViewById(R.id.event_name_remind);
        ...
        Spinner repeatSpinner = (Spinner) view.findViewById(R.id.repeatSpinner);
        ...
        Spinner quantitySpinner = (Spinner) view.findViewById(R.id.quantitySpinner);
        ...
        arrayRepeatAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        quantitySpinner.setAdapter(arrayQuantityAdapter);
